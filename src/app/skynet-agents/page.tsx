      ...
      <div className="flex-grow">
        ...
        <section className="relative pt-32 pb-20">
          ...
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute -top-20 -left-20 w-96 h-96 bg-gradient-to-br from-purple-600/15 via-teal-500/10 to-blue-600/10 rounded-full blur-3xl animate-pulse-slow"></div>
            <div className="absolute top-1/3 -right-20 w-80 h-80 bg-gradient-to-tr from-purple-600/15 via-blue-500/10 to-teal-500/10 rounded-full blur-3xl animate-pulse-slower"></div>
            <div className="absolute bottom-0 left-1/3 w-96 h-96 bg-gradient-to-br from-teal-400/10 via-purple-500/15 to-blue-500/10 rounded-full blur-3xl"></div>
          </div>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
              ...
              <div className="lg:w-2/5 space-y-8">
                ...
                <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold leading-none tracking-tight">
                  ...
                  <div className="overflow-hidden">
                    <span className={`block bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-teal-400 to-blue-500 transform ${isLoaded ? 'translate-y-0' : 'translate-y-full'} transition-transform duration-700 delay-300 ease-out`}>
                ...
                <div className="flex flex-col sm:flex-row gap-5 pt-4">
                  <button className="group relative px-8 py-4 rounded-full bg-gradient-to-r from-purple-500 to-teal-500 text-white font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/30 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-purple-400/50 overflow-hidden">
                    <span className="relative z-10">Request Demo</span>
                    <span className="absolute inset-0 bg-gradient-to-r from-purple-400 to-teal-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-xl"></span>
                  </button>
                  <button className="relative px-8 py-4 rounded-full border border-gray-700 backdrop-blur-lg text-white transition-all duration-300 hover:border-purple-400 focus:outline-none focus:ring-2 focus:ring-purple-400/30 overflow-hidden group">
                    <span className="relative z-10">Learn More</span>
                    <span className="absolute inset-0 bg-gradient-to-r from-gray-800 to-gray-900 opacity-80"></span>
                    <span className="absolute inset-0 bg-gradient-to-r from-purple-500/20 to-teal-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                  </button>
                </div>
              ...
              <div className="lg:w-3/5 relative">
                <div className="relative max-w-2xl mx-auto">
                  ...
                  <div className="absolute bottom-4 -left-12 w-20 h-20 bg-gradient-to-br from-teal-500/30 to-purple-400/30 rounded-lg float-2 opacity-70 shadow-lg shadow-teal-500/20 backdrop-blur-sm border border-teal-400/30">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-[10px] text-white/70 text-center">
                  ...
                  <div className="absolute top-1/3 -left-6 w-12 h-12 bg-gradient-to-r from-blue-500/30 to-purple-400/30 rounded-full float-3 opacity-70 shadow-lg shadow-blue-500/20 backdrop-blur-sm border border-blue-400/30">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="w-2 h-2 rounded-full bg-white/70 animate-ping-slow"></div>
                    </div>
                  </div>
                  <div className="absolute -bottom-8 right-1/3 w-16 h-16 bg-gradient-to-r from-purple-500/30 to-teal-500/30 rounded-md float-2 opacity-70 transform rotate-12 shadow-lg shadow-purple-500/20 backdrop-blur-sm border border-purple-400/30"></div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="mb-8 flex justify-center">
                <div className="inline-flex bg-gray-800/40 backdrop-blur-sm rounded-full p-1.5 border border-gray-700">
                  {["Enterprise", "Marketing", "Development", "Finance", "Customer Service"].map((tab, idx) => (
                    <button 
                      key={idx} 
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                        ...
                        <div className="space-y-5">
                          ...
                          <div className="bg-gray-800/60 backdrop-blur-md rounded-lg border border-gray-700 p-3 transform transition-all duration-300 hover:border-purple-500/30 hover:shadow-lg hover:shadow-purple-500/5">
                            <div className="flex items-center mb-2">
                              <div className="w-8 h-8 rounded-md bg-purple-500/20 flex items-center justify-center text-lg mr-2">1️⃣</div>
                              <div className="text-sm font-medium text-white">Data Collection Agent</div>
                              <div className="ml-auto">
                                <div className="w-2 h-2 rounded-full bg-green-400 animate-pulse"></div>
                              </div>
                            </div>
                            <p className="text-xs text-gray-400">Automatically gathering data from CRM, analytics platforms, and internal databases</p>
                          </div>
                          ...
                          <div className="bg-gray-800/60 backdrop-blur-md rounded-lg border border-gray-700 p-3 transform transition-all duration-300 hover:border-purple-500/30 hover:shadow-lg hover:shadow-purple-500/5">
                            <div className="flex items-center mb-2">
                              <div className="w-8 h-8 rounded-md bg-purple-500/20 flex items-center justify-center text-lg mr-2">2️⃣</div>
                              <div className="text-sm font-medium text-white">Analysis Agent</div>
                              <div className="ml-auto">
                                <div className="w-2 h-2 rounded-full bg-green-400 animate-pulse"></div>
                              </div>
                            </div>
                            <p className="text-xs text-gray-400">Processing collected data to identify trends, anomalies, and business opportunities</p>
                          </div>
                          ...
                          <div className="bg-gray-800/60 backdrop-blur-md rounded-lg border border-gray-700 p-3 transform transition-all duration-300 hover:border-purple-500/30 hover:shadow-lg hover:shadow-purple-500/5">
                            <div className="flex items-center mb-2">
                              <div className="w-8 h-8 rounded-md bg-purple-500/20 flex items-center justify-center text-lg mr-2">3️⃣</div>
                              <div className="text-sm font-medium text-white">Reporting Agent</div>
                              <div className="ml-auto">
                                <div className="w-2 h-2 rounded-full bg-green-400 animate-pulse"></div>
                              </div>
                            </div>
                            <p className="text-xs text-gray-400">Generating comprehensive reports, sending summaries to stakeholders via multiple channels</p>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="space-y-8">
                  ...
                  <p className="text-gray-300">
                    Transform how your organization handles critical data with a coordinated system of autonomous agents that collect, analyze, and report insights without human intervention.
                  </p>
                  
                  <div className="space-y-4">
                    <div className="flex items-start">
                      <div className="flex-shrink-0 w-5 h-5 rounded-full bg-purple-500/20 flex items-center justify-center mt-0.5 mr-3">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 text-purple-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                        </svg>
                      </div>
                      <div>
                        <h4 className="text-white font-medium">Reduce data processing time by 85%</h4>
                        <p className="text-sm text-gray-400">Agents work 24/7 without breaks, continuously processing information</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <h4 className="text-white font-medium">Eliminate reporting errors</h4>
                        <p className="text-sm text-gray-400">Consistent methodology with built-in verification ensures accuracy</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <h4 className="text-white font-medium">Free up 20+ hours per week for analysts</h4>
                        <p className="text-sm text-gray-400">Allow your team to focus on strategy instead of data processing</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="pt-4">
                    <div className="flex flex-col sm:flex-row gap-4">
                      <button className="px-6 py-3 rounded-full bg-gradient-to-r from-purple-500 to-teal-500 text-white font-medium transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/30 hover:scale-105">
                        See Detailed Case Study
                      </button>
                      <button className="px-6 py-3 rounded-full border border-gray-700 text-white font-medium transition-all duration-300 hover:border-purple-500/30">
                        Request Demo
                      </button>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-20">
                {[
                  ...
                  <div key={idx} className="bg-gray-800/30 backdrop-blur-sm rounded-xl border border-gray-700 p-6 hover:border-purple-500/30 transition-colors duration-300">
                    <div className="w-12 h-12 rounded-lg bg-purple-500/10 flex items-center justify-center mb-4 text-2xl">
                      {useCase.icon}
                    </div>
                    <h3 className="text-lg font-bold text-white mb-2">{useCase.title}</h3>
                    <p className="text-gray-400 text-sm mb-4">{useCase.desc}</p>
                    <button className="text-purple-400 text-sm font-medium hover:text-purple-300 transition-colors duration-300 flex items-center">
