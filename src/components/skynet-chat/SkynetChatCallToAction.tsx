              ...
              {!submitted ? (
                <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-8 items-stretch">
                  ...
                  <div className="md:w-1/2 space-y-6">
                    <div className="flex items-start group transition-all duration-300 hover:bg-gray-800/30 p-4 rounded-lg cursor-pointer" onClick={() => window.location.href='mailto:admin@asyncstudios.co.uk'}>
                    ...
                    <div className="flex items-start group transition-all duration-300 hover:bg-gray-800/30 p-4 rounded-lg cursor-pointer" onClick={() => window.location.href = 'mailto:admin@asyncstudios.co.uk'}>
                      ...
                      <div className="ml-3">
                        ...
                        <p className="text-gray-400">Contact us to discover applications for your industry</p>
                      </div>
                    </div>
