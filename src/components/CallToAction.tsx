    ...
    <div className="relative py-24 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-gray-800/50 p-8 rounded-2xl border border-gray-700 backdrop-blur-sm hover:shadow-xl hover:shadow-teal-500/5 transition-all duration-300 mb-8">
            {!submitted ? (
